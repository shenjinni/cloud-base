				...
				*//*if(null != tu && null != tu.getLocalUserId()){
					...
					if(null != u){//已关联账号
						...
						if (sbj.isAuthenticated()) {
							...
							resp.sendRedirect(serverDomain + "/baseSjn/");
							return;
						}
						...
						if(i == 1){
							resp.sendRedirect(serverDomain + "/baseSjn/common/thirdUserConnect.do?thirdId="+userId+"&userType=YW");
							return;
						}
					}
				}else{//第一次登陆
